...
commodity_dict = {
    ...
    "mustard_seeds": "static/Mustard_seeds.csv",
...
if __name__ == "__main__":
    ...
    seasame = Commodity(commodity_dict["seasame"])
    commodity_list.append(seasame)
    ...
    mustard_seeds = Commodity(commodity_dict["mustard_seeds"])
    commodity_list.append(mustard_seeds)
